...
CLICKING ON ACTIVE LINK MAKES ORANGE BORDER BOTTOM DISAPPEAR (REMOVES ACTIVE CLASS)

PREVENT LETTER SPACING CHANGE WITH BUTTON / LINK HOVER
    ☑️ NOW SPACING SHRINKS ON PURPOSE
...
HIDE BACKGROUND ENTIRELY WITH TIMER, DON'T SHOW APP BORDER
    REFACTOR THIS WITH CSS CLASSES, ADD ANIMATION TO COVER IMG
        ☑️ COVER IMG CONTAINER ADDED TO FADEOUT WITH TIMER ARRAY

☑️ INCREASE BORDER RADIUS ON CONTAINERS TO MATCH BACKGROUND IMG?
☑️ MAKE LIGHT THEME FOOTER NON TRANSPARENT
MAKE FOOTER CSS
☑️ BUG: SPACE ON APP/CONTAINERS TRIGGERS PAGE SCROLL
